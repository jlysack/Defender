...
classdef DevAdf4159<handle
    ...
    methods (Access = public)
        ...
        function Data   =   GenRegs(obj)
            ...
            NrStepsDown         =   floor(obj.TRampDo/1e-6);
            fDevUp              =   BDiv/NrStepsUp;
            DevUp               =   fDevUp/fRes;
            DevOffsUp           =   ceil(log10(DevUp/8000)/log10(2));
            DevValUp            =   round(DevUp/(2.^DevOffsUp)/4)*4;
            
            fDevDown            =   BDiv/NrStepsDown;
            DevDown             =   fDevDown/fRes;
            DevOffsDown         =   ceil(log10(DevDown/8000)/log10(2));
            DevValDown          =   round(DevDown/(2.^DevOffsDown)/4)*4;
            ...
            Data                =   [];
            Data(1)             =   obj.GenRegFlag('R7_Delay', 0, 'TxTrig',1, 'FastRamp', 0, 'SingFullTri', 0);
            Data(2)             =   obj.GenRegFlag('R6_Step', 0, 'StepWrd', NrStepsUp, 'StepSel', 0);
            Data(3)             =   obj.GenRegFlag('R6_Step', 0, 'StepWrd', NrStepsDown, 'StepSel', 1);
            Data(4)             =   obj.GenRegFlag('R5_Dev', 0, 'DevWrd', DevValUp, 'DevOffs', DevOffsUp, 'DevSel', 0, 'DualRamp' , 0);
            Data(5)             =   obj.GenRegFlag('R5_Dev', 0, 'DevWrd', DevValDown, 'DevOffs', DevOffsDown, 'DevSel', 1, 'DualRamp' , 0);
            ...
            Data(8)             =   obj.GenRegFlag('R3_Func', 0, 'PDPol', 1, 'RampMod', 2);
            Data(9)             =   obj.GenRegFlag('R2_Div', 0, 'Clk1Div', Clk1, 'RCntr', obj.ValR, 'RefDoub', obj.ValD, 'RDiv2', obj.ValT, 'PreSca', 1, 'CP', 4);
            Data(10)            =   obj.GenRegFlag('R1_LsbFrac', 0, 'Frac', NStrtFracLsb);
            Data(11)            =   obj.GenRegFlag('R0_FracInt', 0, 'Frac', NStrtFracMsb, 'Int', NStrtInt, 'RampOn', 1);
