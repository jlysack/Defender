...
class DevAdf4159(DevDriver.DevDriver):
    ...
    def     GenRegs(self):
        ...
        Data[0]             =   self.GenRegFlag('R7_Delay', 0, 'TxTrig', 1, 'FastRamp', 0, 'SingFullTri', 0)
        ...
        Data[8]             =   self.GenRegFlag('R2_Div', 0, 'Clk1Div', Clk1, 'RCntr', self.ValR, 'RefDoub', self.ValD, 'RDiv2', self.ValT, 'PreSca', 1, 'CP', 4)
        Data[9]             =   self.GenRegFlag('R1_LsbFrac', 0, 'Frac', NStrtFracLsb)
        Data[10]            =   self.GenRegFlag('R0_FracInt', 0, 'Frac', NStrtFracMsb, 'Int', NStrtInt, 'RampOn', 1)
