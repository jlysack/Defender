...
classdef TinyRad<UsbAdi
    ...
    methods (Access = public)
        ...
        function    Ret     =   Dsp_StrtMeas(obj, Cfg)
            ...
            obj.Rad_N       =   Cfg.N;
            Ticks           =   round(Cfg.Perd./10e-9);
            disp(['Ticks: ', num2str(Ticks)])
            DspCmd          =   zeros(4, 1);
            Cod             =   hex2dec('9031');
            DspCmd(1)       =   1;
            DspCmd(2)       =   1;
        ...
        function    Ret     =   Dsp_GetDat(obj, Len)
            ...
            Ret             =   obj.CmdReadDatLen(0, Cod, DspCmd);
        end        
        
        function    Dat     =   BrdGetData(obj)
            Len             =   4*obj.Rad_N*numel(obj.Seq).*obj.FrmMeasSiz;
