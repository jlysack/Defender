...
class DevAdf4159(DevDriver.DevDriver):
    ...
    def GenRegs(self):
        ...
        fPfd = self.fRefIn * (
            (1 + self.ValD) / (self.ValR * (1 + self.ValT))
        )  # calculate internal PFD frequency
        NStrt = fStrtDiv / fPfd
        ...
        Data[0] = self.GenRegFlag(
            "R7_Delay", 0, "TxTrig", 1, "FastRamp", 0, "SingFullTri", 0
        )
        ...
        Data[3] = self.GenRegFlag(
            "R5_Dev", 0, "DevWrd", DevValUp, "DevOffs", DevOffsUp, "DevSel", 0
        )
        Data[4] = self.GenRegFlag(
            "R5_Dev", 0, "DevWrd", DevValDown, "DevOffs", DevOffsDown, "DevSel", 1
        )
        Data[5] = self.GenRegFlag(
            "R4_Clk", 0, "ClkDivSel", 0, "Clk2Div", Clk2, "ClkDivMod", 3, "RampSts", 4
        )
        Data[6] = self.GenRegFlag(
            "R4_Clk", 0, "ClkDivSel", 1, "Clk2Div", Clk2, "ClkDivMod", 3, "RampSts", 4
        )
        Data[7] = self.GenRegFlag("R3_Func", 0, "PDPol", 1, "RampMod", 2)
        Data[8] = self.GenRegFlag(
            "R2_Div",
            0,
            "Clk1Div",
            Clk1,
        ...
        Data[10] = self.GenRegFlag(
            "R0_FracInt", 0, "Frac", NStrtFracMsb, "Int", NStrtInt, "RampOn", 1
        )
