...
class DevAdf5901(DevDriver.DevDriver):
    ...
    def __init__(self, Brd, dUSpiCfg):
        ...
        self.DefineConst()
        self.RegR0Final = self.GenRegFlag(
            "R0",
            0,
            "AuxBufGain",
            4,
    ...
    def GenRegs(self):
        ...
        Data[5] = self.GenRegFlag(
            "R7", 0, "RDiv", self.RfRefDiv, "ClkDiv", 500, "RDiv2", Flag
        )  # 0x011F4827,
        ...
        # Reserved: Frac MSB:
        # --------------------------------------------------------------
        Data[7] = self.GenRegFlag(
            "R5", 0, "FracMsb", DivFracMsb, "Int", DivInt
        )  # 0x01E28005
        # --------------------------------------------------------------
        ...
        Data[10] = int(
            "0x00020642", 0
        )  # self.GenRegFlag('R2', 0, 'AdcClkDiv', 100, 'AdcAv', 0)
        # --------------------------------------------------------------
