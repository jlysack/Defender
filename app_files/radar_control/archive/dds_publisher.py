...
class ddsWriter:
    ...
    detectionData_writer = dds.DataWriter(participant.implicit_publisher, detectionData_topic)
    ...
    IFFResponse_writer = dds.DataWriter(participant.implicit_publisher, IFFResponse_topic)
